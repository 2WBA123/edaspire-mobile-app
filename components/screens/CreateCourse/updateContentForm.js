...
export default function SectionForm({updateContent}){
        ...
        <View style={globalStyles.container}>
            ...
            validationSchema={Schema}
             onSubmit={(values,actions)=>{
              ...
              {(props)=>(
                  <View>
                      <Text style={{textAlign:'center',fontSize:20,color:'#30475e',marginBottom:10}}><Text style={{color:'#f05454',fontSize:23}}>Update</Text> Content</Text>
                      <TextInput 
                      ...
                      <View style={{marginTop:20}}><Button title="Update Content"  color="#f05454"  onPress={props.handleSubmit}/></View>
                  </View>
              )}
